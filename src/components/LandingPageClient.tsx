...
import HeroVideo, { HeroVideoData } from '@/components/HeroVideo';

interface LandingPageClientProps {
  heroVideos: HeroVideoData[];
}

export default function LandingPageClient({ heroVideos }: LandingPageClientProps) {
  return (
    <main className="min-h-screen bg-[#F9F6F0] text-[#3E3A36] overflow-x-hidden font-sans">
      ...
      <section className="relative w-full h-screen flex items-center justify-center overflow-hidden bg-black">
        ...
        <div className="absolute inset-0 z-10 bg-gradient-to-b from-black/60 via-black/20 to-black/90" />
